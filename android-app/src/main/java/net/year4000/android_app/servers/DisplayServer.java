...
public class DisplayServer extends Activity {
    ...
    private static final ImmutableMap<String, String> COLORS = ImmutableMap.<String, String>builder()
            .put("§a", "#55ff55").put("§b", "#55ffff").put("§c", "#ff5555")
            .put("§d", "#ff55ff").put("§e", "#ffff55").put("§f", "#ffffff")
            .put("§0", "#000000").put("§1", "#0000aa").put("§2", "#00aa00")
            .put("§3", "#00aaaa").put("§4", "#aa0000").put("§5", "#aa00aa")
            .put("§6", "#ffaa00").put("§7", "#aaaaaa").put("§8", "#555555")
            .put("§9", "#5555ff").put("§k", "#ffffff").put("§o", "#ffffff")
            .put("§l", "#ffffff").put("§m", "#ffffff").put("§r", "#ffffff")
            .build();
